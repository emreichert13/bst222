...
predicted_logistic <- predict(logistic_mod, data = SimRes, type="response")

auc(SimRes$suicide, predicted_logistic)

pred = prediction(predicted_logistic, SimRes$suicide)
